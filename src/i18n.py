...
T = {
    ...
    "lbl_pending_hint_start": {"en": "Set IN to start a clip (I key / Ctrl-click the timeline)",
                               "ja": "IN を打つと切り抜き開始（I キー / タイムラインを Ctrl+クリック）"},
    "tip_pending_in":    {"en": "Press I or Ctrl-click the timeline to set the In point",
                          "ja": "I キー、またはタイムラインを Ctrl+クリックで IN を設定"},
